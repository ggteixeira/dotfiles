...
alias updateall='sudo apt update && sudo apt upgrade && sudo apt autoremove && sudo apt autoclean && sudo apt clean && sudo snap refresh && flatpak update -y && fisher update && omf update'
alias please='sudo'
